...
<div class="container">
    ...
    <jsp:useBean id="formBean" class="dmit2015.model.CanadianPersonalIncomeTax" scope="request">
        <jsp:setProperty name="formBean" property="*"/>
    </jsp:useBean>

    <form id="form1" method="post">
        <div class="form-group">
            <label for="taxableIncome">Text Value</label>
            <input type="number" class="form-control" id="taxableIncome"
                   name="taxableIncome" value="${formBean.taxableIncome}"/>
        </div>
    ...
    <c:if test="${pageContext.request.method == 'POST'}">
        <b>Federal Income Tax:</b>    ${formBean.federalIncomeTax()} <br/>
        <b>Provincial Income Tax:</b> ${formBean.provincialIncomeTax()} <br/>
        <b>Total Income Tax:</b> ${formBean.totalIncomeTax()} <br/>
